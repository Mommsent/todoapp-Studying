...
func (h *TasksHTTPHandler) GetTasks(rw http.ResponseWriter, r *http.Request) {
	...
	userID, limit, offset, err := getUserLimitOffsetQueryParams(r)
	if err != nil {
...
func getUserLimitOffsetQueryParams(request *http.Request) (*int, *int, *int, error) {
	const (
	...
	userID, err := core_http_request.GetIntQueryParam(request, userIDQueryParamKey)
	if err != nil {
