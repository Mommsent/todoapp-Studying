...
func (r *PatchTaskRequest) Validate() error {
	...
	if r.Completed.Set {
		if r.Completed.Value == nil {
			return fmt.Errorf("'Completed' cnat be NULL")
		}
	}
...
// @Description 1. **Поле не передано**: поле `description` игнорируется в БД не меняется
// @Description 2. **Явно передано значение**: `"description":"абоба"` устанавливает новое описание для задачи в БД
...
// @Failuer     404 {object} core_http_response.ErrorResponse "Task not found"
